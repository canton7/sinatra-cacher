...
spec = Gem::Specification.new do |s|
  ...
  s.description = 'Simple and effective file-based caching for sinatra. Caches routes, blocks, or HTML fragments. Sets ETag correctly. Automatic or manual tag generation. Easy cache clearing.'
